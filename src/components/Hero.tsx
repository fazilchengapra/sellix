...
const Hero = () => {
  return (
    <div className="relative bg-gradient-to-br from-blue-50 via-white to-white overflow-hidden">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl mb-6">
                ...
                <span className="block bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">That Define You</span>
              </h1>
              <p className="mt-4 text-base text-gray-600 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 mb-8">
                Explore our curated collection of premium products, designed for the modern lifestyle. Quality meets exceptional value.
              </p>
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start gap-4">
                <Link to="/products">
                    <Button size="lg" className="w-full sm:w-auto h-12 px-8 shadow-lg hover:shadow-xl transition-all">
                        Shop Now
                        <ShoppingBag className="w-5 h-5 ml-2" />
                    </Button>
                </Link>
                <Link to="/products">
                    <Button variant="outline" size="lg" className="w-full sm:w-auto h-12 px-8 border-2 border-blue-200 hover:border-blue-300 hover:bg-blue-50">
                        View Collection
